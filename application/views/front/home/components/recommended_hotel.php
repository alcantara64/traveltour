  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="recom-item">
          <div class="recom-media"><a href="hotels-details.html">
              <div class="pic"><img src="<?php echo base_url();?>templates/front/pic/recomended/1.jpg" data-at2x="<?php echo base_url();?>templates/front/pic/recomended/1@2x.jpg" alt></div></a>
      ...
      <div class="col-md-6">
        <div class="recom-item">
          <div class="recom-media"><a href="hotels-details.html">
              <div class="pic"><img src="<?php echo base_url();?>templates/front/pic/recomended/2.jpg" data-at2x="<?php echo base_url();?>templates/front/pic/recomended/2@2x.jpg" alt></div></a>
      ...
      <div class="col-md-6">
        <div class="recom-item">
          <div class="recom-media"><a href="hotels-details.html">
              <div class="pic"><img src="<?php echo base_url();?>templates/front/pic/recomended/3.jpg" data-at2x="<?php echo base_url();?>templates/front/pic/recomended/3@2x.jpg" alt></div></a>
      ...
      <div class="col-md-6">
        <div class="recom-item">
          <div class="recom-media"><a href="hotels-details.html">
              <div class="pic"><img src="<?php echo base_url();?>templates/front/pic/recomended/4.jpg" data-at2x="<?php echo base_url();?>templates/front/pic/recomended/4@2x.jpg" alt></div></a>
      ...
      <div class="col-md-6">
        <div class="recom-item">
          <div class="recom-media"><a href="hotels-details.html">
              <div class="pic"><img src="<?php echo base_url();?>templates/front/pic/recomended/5.jpg" data-at2x="<?php echo base_url();?>templates/front/pic/recomended/5@2x.jpg" alt></div></a>
      ...
      <div class="col-md-6">
        <div class="recom-item">
          <div class="recom-media"><a href="hotels-details.html">
              <div class="pic"><img src="<?php echo base_url();?>templates/front/pic/recomended/6.jpg" data-at2x="<?php echo base_url();?>templates/front/pic/recomended/6@2x.jpg" alt></div></a>
